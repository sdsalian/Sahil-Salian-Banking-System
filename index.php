...
<body style="background:#343a40;background-size: 100%">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to Phoenix Treasures</h4>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/5'.GIF" alt="First slide" style="max-height: 250px">
          </div>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/8.GIF" alt="Third slide" style="max-height: 250px">
          </div>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          ...
          <div class="card-body">
            <a href="accounts.php" class="btn btn-outline-success btn-block">Your Account</a>
          </div>
        </div>
      </div>
      <div class="col">
    ...
    <div class="row" style="padding: 22px">
      ...
      <div class="col">
        ...
        <div class="card-body">
          <a href="feedback.php" class="btn btn-outline-primary btn-block">Support</a>
         </div>
        </div>
      </div>
    </div>
