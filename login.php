...
<head>
    ...
    define('bankName', 'Sparks Foundation Presents : Phoenix Treasures',true);
...
<body style="background: url(images/front.jpg);background-size: 90%">
<h1 class="alert alert-Dark rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 15pt;"><kbd>Created by: Sahil Salian</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 22px">
    ...
    <div class="card-header" role="tab" id="headingOne">
      <h5 class="mb-0">
        <a style="text-decoration: none;" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         <button class="btn btn-outline-Dark btn-block">User's Login</button>
        </a>
      </h5>
    </div>
  ...
  <div class="card rounded-0">
    <div class="card-header" role="tab" id="headingTwo">
      <h5 class="mb-0">
        <a class="btn btn-outline-Dark btn-block" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Manager's Login
        </a>
      </h5>
    </div>
